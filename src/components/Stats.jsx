...
const Stats = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      bgPattern:
        "radial-gradient(circle at 50% 70%, rgba(255,255,255,0.1) 0%, transparent 50%)",
    },
    {
  ...
  return (
    <section className="py-8 md:py-12 bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10">
          {stats.map((stat, index) => (
            ...
            >
              ...
              {/* Icon Container */}
              <div
                className={`w-16 h-16 bg-gradient-to-br ${stat.gradient} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl group-hover:scale-110 transition-transform duration-500 relative overflow-hidden`}
              >
