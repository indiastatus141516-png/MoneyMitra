...
const Blog = ({ articles }) => {
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Stay informed with expert financial advice, market trends, and
            practical tips to help you make smarter money decisions
          </p>
              ...
              <div className="p-6 pb-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <div
                      className={`w-10 h-10 bg-gradient-to-br ${article.gradient} rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
                      <span className="text-lg">{article.icon}</span>
                    </div>
                    <span
                      className={`text-sm font-semibold bg-gradient-to-r ${article.gradient} bg-clip-text text-transparent px-3 py-1 rounded-full border border-gray-200`}
                    >
                      {article.category}
                    </span>
                  </div>
