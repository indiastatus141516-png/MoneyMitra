  ...
  const features = [
    {
      ...
      description: "Get competitive rates that work for you. Our transparent pricing ensures you always know exactly what you're paying, with no hidden fees or surprises.",
      icon: (
    ...
    },
    {
      ...
      description: "Access the funds you need quickly and easily. Whether it's for emergencies, opportunities, or everyday expenses, we've got you covered.",
      icon: (
        <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Benefit from our industry-leading APR rates. We work hard to offer you the most competitive terms available in the market today.",
      icon: (
        <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      bgPattern: "radial-gradient(circle at 50% 70%, rgba(255,255,255,0.2) 0%, transparent 50%)"
    }
  ];

  return (
    <section id="features" className="py-20 md:py-28 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Icon Container */}
              <div className={`w-20 h-20 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-xl group-hover:scale-110 transition-transform duration-500 relative overflow-hidden`}>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
            ...
            <span className="text-gray-700 font-medium">Trusted by over 50,000+ customers worldwide</span>
          </div>
        </div>
      </div>
    </section>
